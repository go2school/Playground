...
#output_dir = '/home/mpi/uwo_big_pos_prediction/'
output_dir = '/home/mpi/'
output_prob_postfix = 'uwo_big_pos_probability.txt'
...
#do svm prediction
mec.execute('file_based_positive_enlarged_multi_label_prediction_with_platts_pav_calibration_feature_shrinkage(input_svm, output_dir, output_prob_postfix, pos_factor, my_cats, my_voc_maps, my_idfs, my_models, my_prob_model_choices, my_platts, my_pav_models, "")')
