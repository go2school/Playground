...
mec.execute('from pl_routin import do_job_adv')
...
mec.execute('do_job_adv(feature_fname + "_" + str(my_id[0]), my_trunk, local_trunk_size, stop_sets, vocabulary)')
