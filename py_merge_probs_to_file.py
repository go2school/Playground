...
if __name__ == '__main__': 				
	...
	in_file_ext = 'to_do_parameter_probability.txt'
	in_folder = '/home/mpi/uwo_to_do_prediction/'
	out_folder = '/home/xiao/uwo_to_do_merged/'
	out_file_ext = 'to_do_parameter_merged_probability.txt'
	...
	p1,p2=check_correctness(out_folder + '/1_' + out_file_ext, 5, in_folder + '5_pos_1_' + in_file_ext)
	for i in range(len(p1)):
		if p1[i] != p2[i]:
			print p1[i], p2[i], 'err'
